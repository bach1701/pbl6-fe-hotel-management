...
const Header = () => {
    ...
    const handleLogout = useCallback((redirectUrl) => {
                    ...
                    <div className="utf_left_side">
                        ...
                        <nav id="navigation" className="style_one">
                            <ul id="responsive">
                                ...
                                <li><a onClick={() => handleScrollAndNavigate('about-us')}>About Us</a></li>
                                <li><a onClick={() => handleScrollAndNavigate('contact')}>Contact</a></li>
                            </ul>
                        </nav>
